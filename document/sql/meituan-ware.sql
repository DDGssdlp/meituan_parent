...
MySQL - 5.7.35 : Database - meituan-ware
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`meituan-ware` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `wms_purchase` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='采购信息';
...
CREATE TABLE `wms_ware_order_task` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='库存工作单';
...
CREATE TABLE `wms_ware_sku` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='商品库存';

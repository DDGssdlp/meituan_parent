...
MySQL - 5.7.35 : Database - meituan-coupon
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`meituan-coupon` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `sms_coupon` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='优惠券信息';
...
CREATE TABLE `sms_coupon_history` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='优惠券领取历史记录';
...
CREATE TABLE `sms_coupon_spu_category_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='优惠券分类关联';
...
CREATE TABLE `sms_coupon_spu_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='优惠券与产品关联';
...
CREATE TABLE `sms_home_adv` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='首页轮播广告';
...
CREATE TABLE `sms_home_subject` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='首页专题表【jd首页下面很多专题，每个专题链接新的页面，展示专题商品信息】';
...
CREATE TABLE `sms_home_subject_spu` (
  ...
  `sort` int(11) DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='专题商品';
...
CREATE TABLE `sms_member_price` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='商品会员价格';
...
CREATE TABLE `sms_seckill_promotion` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='秒杀活动';
...
CREATE TABLE `sms_seckill_session` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='秒杀活动场次';
...
CREATE TABLE `sms_seckill_sku_notice` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='秒杀商品通知订阅';
...
CREATE TABLE `sms_seckill_sku_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='秒杀活动商品关联';
...
CREATE TABLE `sms_sku_full_reduction` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='商品满减信息';
...
CREATE TABLE `sms_sku_ladder` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='商品阶梯价格';
...
CREATE TABLE `sms_spu_bounds` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='商品spu积分设置';
